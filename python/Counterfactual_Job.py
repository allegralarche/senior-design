...
def find_county(coordinates):
    ...
    try:
        cnty = json_res[0]['politics'][2]['code']
        print(res)
    except:
        print(res)

    # county = json_res[0]['politics'][2]['name']
    return cnty
'''
...
'''
''' 
def execute_sql(filename, username):
    cnx = mysql.connector.connect(host='127.0.0.1', port=3306, user=username, db="randomTwitter_by_year")
